...
![updateQueue](https://wangfuyou.com/assets/react-4-KdX66W_G.png)
...
![mount 流程](https://wangfuyou.com/assets/react-5-DFOqdfQK.png)
...
1. 如何将 updateContainer 和 workloop 中的 renderRoot 这个更新流程关联上？

   在 updateContainer 中通过调用 scheduleUpdateOnFiber 函数开始调度更新，从触发更新的节点开始向上遍历，直到达到根节点 FiberRootNode；
